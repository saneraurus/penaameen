...
export const methods: Method[] = [
  {
    ...
    tagline: "Revolusi Belajar Membaca Anak Usia Dini: Mudah, Cepat, Menyenangkan, & Anti Lupa Tanpa Mengeja",
    officialReference: "Dikembangkan oleh Litbang Penerbit Pena Ameen & Portal Resmi AkuCepatMembaca.com",
    ...
    suitableFor: "Anak Usia Dini (PAUD, TK A/B, SD Kelas 1), Anak Berkebutuhan Khusus (ABK/Dyslexia), dan Orang Dewasa Buta Aksara",
    ...
    keyStats: [
      { label: "Target Ketuntasan", value: "16-24 Sesi", detail: "Rata-rata anak lancar membaca" },
      { label: "Metode Asosiasi", value: "100% Tanpa Mengeja", detail: "Tanpa B-A = BA / Tanpa Ejaan" },
      { label: "Komposisi Belajar", value: "70% : 30%", detail: "70% Membaca & 30% Menulis" },
      { label: "Dipercaya Lembaga", value: "500+ Sekolah", detail: "PAUD, TK, SD & Program CSR Pemda" },
    ],
    advantages: [
      {
        icon: "🚫",
    ...
    faqs: [
      {
        question: "Apakah anak usia 3,5 – 4 tahun bisa langsung mengikuti metode ACM?",
        answer:
      ...
      {
        question: "Mengapa metode ACM tidak mengajarkan menghafal abjad A-Z di awal?",
        answer:
      ...
      {
        question: "Bagaimana jika anak sudah terlanjur belajar mengeja di tempat lain dan merasa bingung?",
        answer:
      ...
      {
        question: "Apakah metode ACM bisa diterapkan untuk anak berkebutuhan khusus (ABK / Dyslexia / Speech Delay)?",
        answer:
      ...
      {
        question: "Berapa lama waktu pendampingan harian yang disarankan untuk orang tua?",
        answer:
    ...
    seo: {
      title: "Metode ACM (Aku Cepat Membaca) - Belajar Membaca Anak Tanpa Mengeja | Pena Ameen",
      description:
  ...
  },
  {
    ...
    tagline: "Metode Cepat Membaca Al-Qur'an 200 Menit Anti Lupa Karya KH. Nursyamsu Muhadi",
    officialReference: "Karya Legendaris KH. Nursyamsu Muhadi Sejak 1965 • Diterbitkan oleh Penerbit Pena Ameen",
    ...
    suitableFor: "Anak-anak (Mulai Usia 4 Tahun), Remaja, Mahasiswa, Pemula Dewasa, Mualaf, hingga Lansia",
    ...
    keyStats: [
      { label: "Target Waktu", value: "200 Menit", detail: "Total durasi belajar dari nol" },
      { label: "Formula Kunci", value: "Anti Lupa", detail: "Asosiasi bunyi A-DA-RA-JA" },
      { label: "Jangkauan", value: "30+ Tahun", detail: "Dipakai di Indonesia & Malaysia" },
      { label: "Alumni Santri", value: "1.000.000+", detail: "Santri, mualaf, dan pembelajar" },
    ],
    advantages: [
      {
        icon: "⚡",
        title: "Sistem Kilat 200 Menit Teruji",
        description: "Membagi seluruh kurikulum membaca Al-Qur'an ke dalam 8 bab terstruktur yang tuntas dalam 200 menit.",
      },
      {
        icon: "🧠",
        title: "Rumus Kata Kunci Bunyi 'Anti Lupa'",
        description: "Mengelompokkan 28 huruf hijaiyah ke dalam rumus kata bermakna (A-DA-RA-JA, MA-HA-KA-YA, dsb).",
      },
      {
        icon: "📖",
        title: "Tajwid Aplikatif & Praktis",
        description: "Hukum bacaan panjang, dengung, sukun, dan waqaf diajarkan langsung pada ayat Al-Qur'an tanpa rumus rumit.",
      },
      {
        icon: "👨‍👩‍👧",
        title: "Cocok untuk Belajar Mandiri di Rumah",
        description: "Dapat dipelajari secara mandiri dengan bimbingan modul orang tua atau kit klasikal TPQ.",
      },
    ],
    steps: [
      { step: "Sesi 1-2", title: "Pengenalan Huruf Tunggal (A-DA-RA-JA, MA-HA-KA-YA)", description: "Menguasai 28 huruf hijaiyah melalui rumus kata kunci fonetik." },
      { step: "Sesi 3-4", title: "Huruf Sambung & Baris Panjang (Mad)", description: "Membaca kata bersambung 2 hingga 4 huruf dengan ritme mad tepat." },
      { step: "Sesi 5-6", title: "Tanda Baca Sukun, Tasydid, & Tanwin", description: "Memantapkan artikulasi konsonan mati dan dengung (Ghunnah)." },
      { step: "Sesi 7-8", title: "Tajwid Lengkap & Praktik Membaca Al-Qur'an", description: "Langsung lancar membaca ayat-ayat Al-Qur'an secara tartil." },
    ],
    comparison: {
      conventional: [
    ...
    faqs: [
      {
        question: "Apakah benar-benar bisa lancar membaca Al-Qur'an hanya dalam 200 menit?",
        answer: "Ya! 200 menit adalah total akumulasi waktu belajar efektif (misalnya dibagi menjadi 8 sesi x 25 menit) dengan mengikuti modul Al-Barqy secara disiplin.",
      },
      {
        question: "Apakah orang dewasa atau lansia yang belum pernah belajar mengaji bisa ikut?",
        answer: "Sangat bisa. Al-Barqy adalah salah satu metode terfavorit untuk program bimbingan membaca Al-Qur'an bagi mualaf, mahasiswa, dan orang dewasa karena penyampaian materinya yang sangat logis dan sistematis.",
      },
    ],
    relatedProductSlugs: [
    ...
    seo: {
      title: "Metode AL-BARQY (Belajar Cepat Membaca Al-Qur'an 200 Menit Anti Lupa) | Pena Ameen",
      description:
