...
export default function BranchListPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FBF9F5]">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-primary-950 via-primary-900 to-primary-950 text-white py-14 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10 max-w-4xl text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-secondary-400/15 border border-secondary-400/30 text-secondary-300 text-xs font-semibold mb-4 tracking-wide uppercase">
            <span>📍</span>
            <span>Titik Perwakilan &amp; Mitra Edukasi</span>
          </div>
          ...
          <p className="text-supporting-200 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
            Temukan kantor cabang resmi, perwakilan bimbingan belajar, dan mitra
            distributor metode Al-Barqy &amp; ACM di kota Anda.
          </p>

          <div className="mt-8 flex flex-wrap justify-center items-center gap-6 text-xs sm:text-sm text-supporting-300 border-t border-white/10 pt-6">
            <div className="flex items-center gap-2">
      ...
      <main className="py-10">
        <div className="container px-4 mx-auto max-w-6xl">
          ...
          <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-xs border border-supporting-200/80 mb-8">
            ...
            {filteredBranches.length > 0 ? (
              filteredBranches.map((branch) => {
                ...
                return (
                  <div
                    key={branch.id}
                    className="group bg-white rounded-2xl p-6 shadow-xs hover:shadow-md border border-supporting-200/80 hover:border-primary-300 transition-all duration-200 flex flex-col justify-between"
                  >
                    <div>
