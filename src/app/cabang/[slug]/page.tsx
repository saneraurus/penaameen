...
export default function BranchDetailPage(props?: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-background-50">
      {/* Hero Banner */}
      <section className="relative overflow-hidden bg-primary-950 text-white py-20 md:py-28">
        ...
        <Shell className="relative z-10">
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex flex-wrap items-center gap-2 text-xs text-background-300">
              <li>
                <Link
                  href="/cabang"
          ...
          <Reveal variant="micro">
            <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 border border-white/20 text-xs font-semibold uppercase tracking-wider text-primary-300 mb-4">
              <span
          ...
          <Reveal variant="large" delay={0.05}>
            <h1 className="display-type mt-4 text-[clamp(2.5rem,7vw,5rem)] text-background-50">
              Cabang {branch.region}
            </h1>
          </Reveal>

          <Reveal variant="medium" delay={0.1}>
            <p className="lede mt-5 max-w-2xl text-background-200">
              {hasOutlets
                ...
                {filteredOutlets.map((outlet, index) => {
                  ...
                  return (
                    <Reveal
                      ...
                      delay={index * 0.04}
                    >
                      <div className="bg-white rounded-2xl p-6 sm:p-7 shadow-xs border border-supporting-200/80 hover:border-primary-300 transition-all duration-200">
