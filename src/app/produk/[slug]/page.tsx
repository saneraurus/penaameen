...
export default function ProductDetailPage() {
  ...
  const [activeTab, setActiveTab] = useState<"isi" | "keunggulan" | "spesifikasi" | "panduan" | "faq">("isi");
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      alert(err instanceof Error ? err.message : "Gagal menambahkan produk ke keranjang");
    } finally {
      setIsAdding(false);
    }
  };
    ...
    return (
      <div className="min-h-screen bg-background-50 flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm font-medium text-supporting-600">Memuat rincian produk...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-background-50 flex items-center justify-center p-4">
        <div className="text-center bg-white rounded-3xl p-8 border border-supporting-200 shadow-md max-w-md">
          ...
          <h1 className="text-2xl font-serif font-bold text-primary-950 mb-2">Produk Tidak Ditemukan</h1>
          <p className="text-sm text-supporting-600 mb-6">
            Mohon maaf, produk yang Anda cari tidak tersedia atau tautan telah kedaluwarsa.
          </p>
          <Link
            href="/produk"
  ...
  const relevantReviews = testimonials.filter((t) => t.rating === 5).slice(0, 3);
    ...
    <div className="min-h-screen bg-background-50 text-supporting-900 pb-20">
        ...
        <div className="container px-4 mx-auto py-3.5">
          <nav aria-label="Breadcrumb" className="flex items-center justify-between gap-4">
            <ol className="flex flex-wrap items-center gap-1.5 text-xs text-supporting-500 list-none p-0 m-0">
              ...
              <li>
                <Link href="/produk" className="hover:text-primary-700 transition-colors">
                  Produk
                </Link>
              </li>
              <li aria-hidden="true">/</li>
              ...
              <li aria-hidden="true">/</li>
              <li className="font-semibold text-primary-900 max-w-[200px] truncate" aria-current="page">
                {product.name}
              </li>
            </ol>
      ...
      {addedToast && (
        <div className="fixed top-16 right-4 z-50 bg-primary-950 text-white px-5 py-3.5 rounded-2xl shadow-2xl border border-emerald-500/40 flex items-center gap-3 animate-in fade-in slide-in-from-top-4 duration-300">
          ...
          <div>
            <p className="text-xs font-bold text-white">Berhasil Ditambahkan ke Keranjang!</p>
            <p className="text-[11px] text-emerald-300">{quantity}x {product.name}</p>
          </div>
          <Link
        ...
        <div className="container px-4 mx-auto">
            ...
            <div className="lg:col-span-6 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 pt-2">
                {[
                  ...
                  { icon: "⚡", title: "Garansi Retur", sub: "Jika Cacat Kirim" },
                  { icon: "🚚", title: "Kirim Nasional", sub: "JNE, POS, TIKI" },
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-primary-950 leading-tight">{badge.title}</span>
                    <span className="text-[10px] text-supporting-500">{badge.sub}</span>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-2.5 mb-3">
                  ...
                  <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-50 border border-amber-200 text-xs font-bold text-amber-800">
                    ...
                    <span className="text-amber-600 font-normal">({richDetail?.reviewCount ?? 3200}+ Ulasan)</span>
                  </div>
                  <span className="text-xs text-supporting-400">•</span>
                  <span className="text-xs font-semibold text-emerald-700">100% Pembeli Puas</span>
                </div>
                ...
                <div className="p-5 rounded-2xl bg-gradient-to-br from-primary-950 via-primary-900 to-primary-950 text-white shadow-lg border border-primary-800 mb-6">
                  ...
                  <p className="text-xs text-white/80 border-t border-white/10 pt-3 mt-2 flex items-center gap-1.5">
                    ...
                    <span>Termasuk garansi produk 100% orisinal + bonus konsultasi metode</span>
                  </p>
                </div>
                ...
                <div className="space-y-2 mb-6">
                  {(richDetail?.keyBenefits.slice(0, 3) ?? [
                    { title: "Metode Anti-Lupa 200 Menit", description: "Terbukti mengantarkan ribuan pembelajar lancar membaca." },
                    { title: "Lengkap & Praktis", description: "Buku, kartu, poster dalam satu paket praktis." },
                    { title: "Kualitas Standar Premium", description: "Kertas tebal tahan lama ramah anak." },
                  ]).map((ben, idx) => (
                    <div key={idx} className="flex items-start gap-2.5 text-xs sm:text-sm">
                      ...
                      <p className="text-supporting-700 leading-snug">
                        <strong className="font-semibold text-primary-950">{ben.title}:</strong> {ben.description}
                      </p>
                    </div>
                  ))}
                </div>
                ...
                <div className="p-5 rounded-2xl bg-white border border-supporting-200/80 shadow-xs space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                    ...
                    >
                      {isAdding ? (
                        ...
                        <>
                          <svg className="w-4 h-4 text-primary-700" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                  ...
                  <div className="pt-2 text-center">
                    ...
                    >
                      ...
                      <span className="font-semibold underline">Hubungi CS Pena Ameen</span>
                    </Link>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-10 border border-supporting-200 shadow-sm mb-16">
            ...
            <div className="flex flex-wrap gap-2 border-b border-supporting-200 pb-4 mb-8">
              {[
                { id: "isi", label: "📦 Kelengkapan Isi Paket", count: richDetail?.boxContents.length },
                { id: "keunggulan", label: "⚡ Keunggulan Metode", count: richDetail?.keyBenefits.length },
                { id: "spesifikasi", label: "📋 Spesifikasi Produk" },
                { id: "panduan", label: "🗺️ Panduan 4 Tahap Belajar" },
                { id: "faq", label: "❓ Tanya Jawab (FAQ)", count: richDetail?.faqs.length },
              ].map((tab) => {
                ...
                return (
                  ...
                  >
                    <span>{tab.label}</span>
                    {tab.count && (
                      <span className={`px-1.5 py-0.5 text-[10px] rounded-md ${isActive ? "bg-white/20 text-white" : "bg-supporting-200 text-supporting-700"}`}>
                        {tab.count}
                      </span>
                    )}
                  </button>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-supporting-600">
                    Setiap paket dikemas secara rapi dan eksklusif dengan 5 item pembelajaran terlengkap:
                  </p>
                </div>

                <div className="grid gap-4 md:grid-cols-2">
                  {(richDetail?.boxContents ?? [
                    { icon: "📖", name: "Buku Utama Al-Barqy", description: "Panduan lengkap membaca Al-Qur'an bertahap." },
                    { icon: "🗂️", name: "Flashcard Hijaiyah", description: "Kartu tebal 2 sisi untuk stimulasi daya ingat visual." },
                  ]).map((item, idx) => (
                    <div
                      key={idx}
                    ...
                    >
                      ...
                      <div>
                        <h4 className="text-sm font-bold text-primary-950 mb-1">{item.name}</h4>
            ...
            {activeTab === "keunggulan" && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-supporting-600">
                    Mengapa ribuan keluarga dan ratusan TPQ memilih metode resmi dari Penerbit Pena Ameen:
                  </p>
                </div>

                <div className="grid gap-4 md:grid-cols-2">
                  {(richDetail?.keyBenefits ?? [
                    { title: "Metode Cepat 200 Menit", description: "Kurikulum teruji untuk mempercepat penguasaan baca Al-Qur'an." },
                  ]).map((ben, idx) => (
                    <div
                      key={idx}
                    ...
                    >
                      ...
                      <div>
                        <h4 className="text-sm font-bold text-primary-900 mb-1">{ben.title}</h4>
                        <p className="text-xs text-supporting-600 leading-relaxed">{ben.description}</p>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            {activeTab === "spesifikasi" && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-supporting-600">
                    Informasi lengkap mengenai penerbitan dan kualitas fisik buku:
                  </p>
                </div>
                ...
                <div className="grid gap-3 sm:grid-cols-2 max-w-3xl">
                  {[
                    ...
                    { label: "Penulis", value: richDetail?.author ?? "KH. Nursyamsu Muhadi" },
                    { label: "Penerbit", value: richDetail?.publisher ?? "Penerbit Pena Ameen" },
                    { label: "Berat Paket", value: richDetail?.weight ?? "1.800 gram (1.8 kg)" },
                    { label: "Dimensi Kemasan", value: richDetail?.dimensions ?? "32 cm x 24 cm x 6 cm" },
                    { label: "Bahasa", value: richDetail?.language ?? "Arab & Bahasa Indonesia" },
                    { label: "Sasaran Pengguna", value: richDetail?.targetAge ?? "Anak-anak & Pemula" },
                    { label: "ISBN / Seri", value: richDetail?.isbn ?? "978-602-8920-11-4" },
                    ...
                    >
                      <span className="text-supporting-500 font-medium">{row.label}</span>
                      <span className="font-bold text-primary-950 text-right">{row.value}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            {activeTab === "panduan" && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-supporting-600">
                    Cukup 15–20 menit sehari mengikuti 4 tahapan sistematis berikut:
                  </p>
                </div>

                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                  {(richDetail?.learningSteps ?? [
                    { step: "Tahap 1", title: "Pengenalan Bunyi", description: "Mengenal huruf melalui flashcard dan poster." },
                  ]).map((step, idx) => (
                    <div
                      key={idx}
                    ...
                    >
                      <div>
                        ...
                        <h4 className="text-sm font-bold text-primary-950 mb-2">{step.title}</h4>
                        <p className="text-xs text-supporting-600 leading-relaxed">{step.description}</p>
                      </div>
            ...
            {activeTab === "faq" && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-supporting-600">
                    Temukan jawaban atas pertanyaan umum seputar pemesanan dan metode belajar:
                  </p>
                </div>

                <div className="space-y-3 max-w-3xl">
                  {(richDetail?.faqs ?? [
                    { question: "Bagaimana cara memesan?", answer: "Klik tombol Tambah Keranjang atau Beli Sekarang." },
                  ]).map((faq, idx) => (
                    <div key={idx} className="p-4 rounded-2xl bg-supporting-50 border border-supporting-200">
          ...
          <section className="mb-16">
            <div className="flex flex-wrap items-end justify-between gap-4 mb-8">
              ...
              <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-2xl border border-supporting-200 shadow-2xs">
                ...
                <span className="text-sm font-bold text-primary-950">4.9 dari 5.0</span>
              </div>
            </div>
              ...
              {relevantReviews.map((rev) => (
                ...
                >
                  ...
                  <div className="pt-3 border-t border-supporting-100 flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs font-bold text-primary-950">{rev.name}</p>
                      <p className="text-[10px] text-supporting-500">{rev.role}</p>
                    </div>
                  </div>
                </div>
              ))}
      ...
      <div className="fixed bottom-0 inset-x-0 z-30 bg-white/95 backdrop-blur-md border-t border-supporting-200 p-3.5 shadow-xl sm:hidden">
        <div className="flex items-center justify-between gap-3">
          <div>
            <span className="text-[10px] text-supporting-500 block">Total Harga</span>
